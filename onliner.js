    ...
    online() {
        ...
        this.bot.on('ready', () => {
            this.bot.user.setPresence({
                game: {
                    name: items[Math.floor(Math.random() * items.length)], //bu ne yarram
                    type: "PLAYING",
                    url: "https://webdunyam.net"
                }
            });
        });
...
process.title = ` Yigit Onliner [Token] Toplam Hesaplar: ${tokens.length}`;
console.log(colors.green(`Yigit Onliner`) + (colors.magenta(`Selam `)) + (colors.cyan(`[Token] `)) + (colors.red(`Toplam Yuklenen Hesaplar: ${tokens.length}`)));
console.log("__   __  ___    ____   ___   _____     _____    ___   _  __  _____   _   _      ___    _   _   _       ___   _   _   _____   ____  ");
console.log("\ \ / / |_ _|  / ___| |_ _| |_   _|   |_   _|  / _ \  | |/ / | ____| | \ | |    / _ \  | \ | | | |     |_ _| | \ | | | ____| |  _ \ ");
console.log(" \ V /   | |  | |  _   | |    | |       | |   | | | | | ' /  |  _|   |  \| |   | | | | |  \| | | |      | |  |  \| | |  _|   | |_) |");
console.log("  | |    | |  | |_| |  | |    | |       | |   | |_| | | . \  | |___  | |\  |   | |_| | | |\  | | |___   | |  | |\  | | |___  |  _ < ");
console.log("  |_|   |___|  \____| |___|   |_|       |_|    \___/  |_|\_\ |_____| |_| \_|    \___/  |_| \_| |_____| |___| |_| \_| |_____| |_| \_\ ");
console.log("");
console.log(colors.underline(colors.green(`                        Created By Yigit`)));
console.log(colors.inverse(`[Bilgi] - [Yigit] Tarafından Yapılmışdır`));
